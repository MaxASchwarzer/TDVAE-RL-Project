...
if __name__ == '__main__':
    ...
    arg(parser, 'add_replay_every', type=int, default=8, help='Take an action and add to replay buffer every these ' \
                                                              'many steps')
    arg(parser, 'add_every_start', type=int, default=0, help='Iteration to start decaying epsilon at')
    arg(parser, 'add_every_end', type=int, default=1, help='Iteration to stop decaying epsilon at')
    arg(parser, 'add_every_initial', type=float, default=100, help='Final epsilon for epsilon-greedy')
