...
if __name__ == '__main__':
    ...
    arg(parser, 'optimizer', type=str, default='rmspropc', help='one of: adam, rmspropc')
    arg(parser, 'learning_rate', type=float, default=0.00025, help='-1 to use model default')
    ...
    arg(parser, 'seq_len_decay_end', type=int, default=100000, help='step at which seq len should be at maximum')
